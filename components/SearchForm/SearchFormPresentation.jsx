  ...
  return (
    ...
    >
      <input
        ...
        className="py-3 pl-7 w-5/6 bg-ocher-100 placeholder-gray-600 rounded-tl-full rounded-bl-full focus:outline-none focus:border-none focus:ring-none focus:placeholder-opacity-0"
        value={keyword}
        onChange={onChange}
      />
